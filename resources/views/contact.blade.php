    ...
    <div class="min-h-screen flex flex-col items-center justify-center p-4">
        <div class="w-full max-w-7xl mx-auto py-12">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                {{-- 1. Contact Form --}}
                <div class="bg-base-300 dark:bg-base-200/20 p-8 sm:p-10 rounded-xl shadow-lg border border-gray-100">
                    <h2 class="text-2xl font-bold text-accent dark:text-secondary mb-6">Send us a Message</h2>
                ...
                <div class="space-y-8">
                    ...
                    {{-- Company Details --}}
                    <div class="bg-base-300 dark:bg-base-200/20 p-8 rounded-xl shadow-lg border border-gray-100 space-y-4">
                        <h3 class="text-xl font-bold text-accent dark:text-secondary">Our Office</h3>
                        ...
                        <div class="flex items-start space-x-3">
                            ...
                            <p class="text-accent dark:text-base-300">703 Waterford Way, Suite 600, Miami, FL 33126.</p>
                        </div>
                        ...
                        <div class="flex items-start space-x-3">
                            ...
                            <p class="text-accent dark:text-base-300">support@flightflaremart.com</p>
                        </div>
                        ...
                        <div class="flex items-start space-x-3">
                            ...
                            <p class="text-accent dark:text-base-300">(555) 123-4567</p>
                        </div>
                    </div>
